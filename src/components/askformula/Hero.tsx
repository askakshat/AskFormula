import { Copy, ArrowRight, PlayCircle, Sparkles, BookOpen, Layers, Atom, FileText } from "lucide-react";
...
export default function Hero() {
  return (
    <div className="flex-grow pt-12 flex flex-col items-center w-full">
      ...
      <section className="relative w-full max-w-[1200px] px-6 md:px-12 py-20 md:py-[120px] flex flex-col items-center text-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 mt-16 max-w-3xl">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#272a31] border border-[#32353c] rounded text-[13px] font-mono text-[#e1e2ec] mb-4">
            ...
            <span>v2.0 Academic Edition Released</span>
          </div>
          ...
          <p className="text-base text-[#e1e2ec] max-w-xl">
            A high-density, distraction-free environment for scientific study. Build custom PDF reference sheets tailored to your CBSE Class 11 curriculum in seconds.
          </p>
        ...
        <div className="relative z-10 w-full max-w-2xl mt-16 bg-[#0b0e15] border border-[#32353c] rounded-lg p-6 shadow-2xl overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-4 border-b border-[#32353c] pb-2">
            <span className="text-[13px] font-mono text-[#e1e2ec]">physics/kinematics.tex</span>
          ...
          <div className="grid grid-cols-4 gap-2 border-t border-[#32353c] pt-2">
            <div className="flex flex-col">
              ...
              <span className="text-[11px] font-mono text-[#e1e2ec]">Final Vel.</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[12px] font-bold text-[#aec6ff]">u</span>
              <span className="text-[11px] font-mono text-[#e1e2ec]">Init Vel.</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[12px] font-bold text-[#aec6ff]">a</span>
              <span className="text-[11px] font-mono text-[#e1e2ec]">Accel.</span>
            </div>
            <div className="flex flex-col">
              <span className="text-[12px] font-bold text-[#aec6ff]">s</span>
              <span className="text-[11px] font-mono text-[#e1e2ec]">Displace.</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full max-w-[1200px] px-6 md:px-12 py-16 md:py-24 border-t border-[#32353c] bg-[#11131a]">
        <div className="flex flex-col items-center mb-16">
          <h2 className="text-xl font-semibold text-[#e1e2ec] mb-2">Technical Workflow</h2>
          <p className="text-center max-w-lg text-[#e1e2ec]">
            Generate precise academic reference materials in four deterministic steps.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 lg:gap-6 w-full">
          ...
          <div className="bg-[#11131a] border border-[#32353c] rounded p-4 hover:border-[#aec6ff] transition-colors flex flex-col group">
            <div className="flex justify-between items-start mb-4">
              <span className="font-mono text-[13px] text-[#aec6ff] bg-[#00275d]/20 px-2 py-0.5 rounded">01</span>
              <BookOpen className="w-5 h-5 text-slate-400 group-hover:text-[#aec6ff] transition-colors" />
            </div>
            <h3 className="text-[12px] font-medium text-[#e1e2ec] mb-2 uppercase tracking-wide">Select Board</h3>
            <p className="font-mono text-[13px] text-[#e1e2ec]">Initialize curriculum parameters (e.g., CBSE, ICSE, State).</p>
          </div>

          {/* Step 2 */}
          <div className="bg-[#11131a] border border-[#32353c] rounded p-4 hover:border-[#aec6ff] transition-colors flex flex-col group">
            <div className="flex justify-between items-start mb-4">
              <span className="font-mono text-[13px] text-[#aec6ff] bg-[#00275d]/20 px-2 py-0.5 rounded">02</span>
              <Layers className="w-5 h-5 text-slate-400 group-hover:text-[#aec6ff] transition-colors" />
            </div>
            <h3 className="text-[12px] font-medium text-[#e1e2ec] mb-2 uppercase tracking-wide">Choose Class</h3>
            <p className="font-mono text-[13px] text-[#e1e2ec]">Define academic level requirements (Class 11, Class 12).</p>
          </div>

          {/* Step 3 */}
          <div className="bg-[#11131a] border border-[#32353c] rounded p-4 hover:border-[#aec6ff] transition-colors flex flex-col group">
            <div className="flex justify-between items-start mb-4">
              <span className="font-mono text-[13px] text-[#aec6ff] bg-[#00275d]/20 px-2 py-0.5 rounded">03</span>
              <Atom className="w-5 h-5 text-slate-400 group-hover:text-[#aec6ff] transition-colors" />
            </div>
            <h3 className="text-[12px] font-medium text-[#e1e2ec] mb-2 uppercase tracking-wide">Pick Subject</h3>
            <p className="font-mono text-[13px] text-[#e1e2ec]">Filter knowledge base (Physics, Chemistry, Mathematics).</p>
          </div>

          {/* Step 4 */}
          <div className="bg-[#11131a] border border-[#32353c] rounded p-4 hover:border-[#aec6ff] transition-colors flex flex-col group">
            <div className="flex justify-between items-start mb-4">
              <span className="font-mono text-[13px] text-[#aec6ff] bg-[#00275d]/20 px-2 py-0.5 rounded">04</span>
              <FileText className="w-5 h-5 text-slate-400 group-hover:text-[#aec6ff] transition-colors" />
            </div>
            <h3 className="text-[12px] font-medium text-[#e1e2ec] mb-2 uppercase tracking-wide">Export PDF</h3>
            <p className="font-mono text-[13px] text-[#e1e2ec]">Compile and download formatted LaTeX-style document.</p>
          </div>
        </div>
      </section>
    </div>
