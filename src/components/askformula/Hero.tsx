    ...
    {storyItems.map((item, index) => {
      ...
      return (
        ...
        >
          ...
          <div className="liquid-glass" style={{ direction: "ltr", position: "relative", height: "360px", background: "linear-gradient(145deg, #27333a, #11171c 72%)", borderRadius: "16px", overflow: "hidden", border: "1px solid rgba(242, 240, 233, 0.16)", boxShadow: "0 20px 40px rgba(0,0,0,0.3)" }}>
