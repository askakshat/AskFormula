    ...
    <div className="min-h-screen bg-[#0b0c0f] text-zinc-300 font-sans p-6 md:p-12 lg:p-24 selection:bg-emerald-500/30">
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p>By accessing and using AskFormula, you accept and agree to be bound by the terms and provision of this agreement.</p>
        </section>

        <section className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">2. Educational Use</h2>
          <p>AskFormula is designed as a study aid. While we strive for accuracy in all provided formulas, users should verify critical information against their official textbooks (NCERT).</p>
        </section>
